...
extracted from the
image~\cite{DBLP:conf/emnlp/FukuiPYRDR16, Kim2017, ben2017mutan}.  The feature
...
The methods of~\cite{DBLP:conf/emnlp/FukuiPYRDR16},
...
of~\cite{DBLP:conf/emnlp/FukuiPYRDR16} uses the Compact Bilinear Pooling
...
variables as described in~\cite{DBLP:conf/emnlp/FukuiPYRDR16}, is equal in
