...
\newcommand{\yvosvalG}{66.5}
\newcommand{\inputvar}{\mathbf{X}}
\newcommand{\outputvar}{\mathbf{Y}}
\newcommand{\vidfeat}{\mathbf{T}}
\newcommand{\objfeat}{\mathbf{R}}
\newcommand{\pixel}{\mathbf{p}}
\newcommand{\querytensor}{\mathbf{Q}}
\newcommand{\keytensor}{\mathbf{K}}
\newcommand{\embtensor}{\mathbf{E}}
\newcommand{\valuetensor}{\mathbf{V}}
\newcommand{\objmean}{\bm{\mu}_o}
\newcommand{\objcov}{\bm{\Sigma}_o}
\newcommand{\objctx}{\tilde{\bm{\mu}}_o}
