...
\begin{equation}
        {\Phi\big(A, \valuetensor{}\big)}_\pixel{} =  {A_\pixel{}}^\intercal \Psi\big(\valuetensor{}, \pixel{}\big).
\end{equation}
...
% a~\JandF{} of~\num{70.6}.
According to our DAVIS2017 evaluation, SST performs relatively inaccurately
...
where~$\tilde{I}_\pixel{} = (f(q, \pixel) : q \in I_\pixel)$
